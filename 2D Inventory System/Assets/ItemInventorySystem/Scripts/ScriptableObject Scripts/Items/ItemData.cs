...
namespace DIVH_InventorySystem
{
    ...
    public abstract class ItemData : ScriptableObject
    {
        ...
        /// <summary>
        /// The length of time the item takes to become available again after each use.
        /// </summary>
        ...
        {
            return HashCode.Combine(ItemName, icon, itemCategory, itemType, max_quantity, description, duration);
        }
