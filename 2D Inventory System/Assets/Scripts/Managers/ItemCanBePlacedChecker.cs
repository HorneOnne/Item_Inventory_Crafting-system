...
{
    public class ItemCanBePlacedChecker : Singleton<ItemCanBePlacedChecker>
    {
        [Header("References")]
        ...
        private void Start()
        {
            ...
            itemContainerParent = ItemDataManager.Instance.itemContainerParent;
        }
        ...
        private void SetBoxCollider2D()
        {
            ...
            {
                var itemObject = ItemDataManager.Instance.GetItemPrefab(itemInHand.GetItemData().itemType.ToString());
