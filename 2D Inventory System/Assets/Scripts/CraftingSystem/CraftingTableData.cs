...
public class CraftingTableData : MonoBehaviour
{
    [Header("Container")]
    ...
    {
        UI_DisplayCraftingTable.OnGridChanged += LookupItemFromRecipe;

        //UI_DisplayCraftingTable.OnGetOutputItem += RemoveOutputItemSlot;
        //UI_DisplayCraftingTable.OnGetOutputItem += GetOutputItemSlot;
        
        UI_DisplayCraftingTable.OnGetOutputItem += ComsumeCrafingMaterial;
    }
