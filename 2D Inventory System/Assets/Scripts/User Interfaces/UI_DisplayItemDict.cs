...
public class UI_DisplayItemDict : MonoBehaviour
{
    [Header("Containers")]
    ...
    [SerializeField] UIItemInHand uiItemInHand;
    ...
    public void LoadAllCreativeItemSlotType()
    {
        ...
        int index = 0;
        foreach(var item in ItemDictionary.Instance.itemSet)
        {
    ...
    private void OnSlotClicked(BaseEventData baseEvent, GameObject clickedObj)
    {
        ...
        itemInHand.itemSlot = new ItemSlot(item, item.max_quantity);
